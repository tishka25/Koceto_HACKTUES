...
#define USB_XFER_TIMEOUT		500   //USB transfer timeout in milliseconds, per section 9.2.6.1 of USB 2.0 spec
//#define USB_NAK_LIMIT			32000   //NAK limit for a transfer. 0 means NAKs are not counted
#define USB_RETRY_LIMIT			500     //retry limit for a transfer
#define USB_SETTLE_DELAY		10   //settle delay in milliseconds
